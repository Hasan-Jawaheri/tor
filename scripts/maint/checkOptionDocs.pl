...
open(F, "/mnt/c/Users/Hasan/Downloads/tor/src/or/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/mnt/c/Users/Hasan/Downloads/tor/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/mnt/c/Users/Hasan/Downloads/tor/doc/tor.1.txt") or die;
while (<F>) {
